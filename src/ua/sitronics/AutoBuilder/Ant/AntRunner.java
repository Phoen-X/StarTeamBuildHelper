package ua.sitronics.AutoBuilder.Ant;
...
public class AntRunner
{
	...
	private final File antOutputDir;
	private static final String buildFileName = "build.xml";
	private static final SimpleDateFormat dateFormat = new SimpleDateFormat("ddMMyyyy_HHmm");

	public AntRunner(File moduleDir, File antOutputDir)
	{
